...
class TrainAndPredictTask(BaseDBTask):
    name = 'training_and_prediction_task'

    def run(self, task_code, company_id, upload_code, prediction_request):
...
training_and_prediction_task = TrainAndPredictTask()
